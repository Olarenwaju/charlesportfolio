  ...
  return (
    <div className="w-full fixed top-0 z-50 left-0 right-0">
        <div className="max-w-[1392px] bg-black w-full flex items-center justify-between gap-x-3 mx-auto py-4 sm:py-6 md:py-[40px] px-4 sm:px-5 md:px-10">
            ...
            >
                <Link to="/" onClick={handleClick} className="hover:text-gray-300 transition-colors">Home</Link>
                <Link to="/about" onClick={handleClick} className="hover:text-gray-300 transition-colors">About</Link>
                <Link to="/contact" onClick={handleClick} className="hover:text-gray-300 transition-colors">Contact Me</Link>
            </ul>
            ...
            <ul className="hidden lg:flex gap-x-8 xl:gap-x-[70px] items-center w-fit font-dmsans text-[#ffffffb4] font-normal text-base lg:text-[18px] leading-[24px] uppercase">
                <Link to="/" className="hover:text-white transition-colors">Home
                    <div
                        className={`${
                ...
                <Link to="/about" className="hover:text-white transition-colors">About
                    <div
                        className={`${
                ...
                <Link to="/contact" className="hover:text-white transition-colors">Contact Me
                    <div
                        className={`${
