    ...
    <>
        ...
        <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
            ...
            <div>
                ...
                <p className="text-[50px] sm:text-[60px] md:text-[80px] font-bold pb-5 sm:pb-10">Problems I faced:</p>
                <p className="text-[20px] sm:text-[30px] leading-[40px] sm:leading-[50px] text-[#CCCCCC] font-normal">
        ...
        <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
            <div>
                ...
                <p className="text-[20px] sm:text-[30px] leading-[40px] sm:leading-[50px] text-[#CCCCCC] font-normal pb-5">The Key expectations from Plugtent</p>

                <div className="flex md:flex-row flex-col gap-x-10 gap-y-8 mb-14">
                    <div className="max-w-[550px] mr-20">
                        <p className=" text-white text-[30px] sm:text-[35px] font-bold pt-5 sm:pt-14 pb-10">Businesses:</p>
                        <ul className="list-disc text-[20px] sm:text-[30px] text-[#CCCCCC] font-normal pl-10 md:pl-20">
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Sign up using their E-mail</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Make payment for campaign using debit cards</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Choose to invite creators to join a campaign</li>
                            <li className="leading-10 md:leading-[50px] pb-0 sm:pb-5">Choose to invite multiple co-workers to join workspace and manage campaign on their behalf</li>
                    ...
                    <div className="max-w-[550px]">
                        <p className=" text-white text-[40px] font-bold leading-[26px]">&nbsp;</p>
                        <ul className="list-disc text-[20px] sm:text-[30px] text-[#CCCCCC] font-normal pl-10 md:pl-20">
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Create campaign using texts, images or videos</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Accept or reject a creator proposal to join capmpaigns</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Approve or reject a content submitted by creators</li>   
                        </ul>
                    </div>
                ...
                <div className="flex md:flex-row flex-col gap-x-8 gap-y-8">
                    <div className="max-w-[550px] mr-20">
                        <p className="text-white text-[30px] sm:text-[35px] font-bold pt-5 sm:pt-14 pb-10">Content Creators:</p>
                        <ul className="list-disc text-[20px] sm:text-[30px] text-[#CCCCCC] font-normal pl-10 md:pl-20">
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Sign up using their email</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Connect atleast one(1) social media channel before proceeding to dashboard.</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Add projects to portfolio</li>
                            <li className="leading-10 md:leading-[50px] pb-0 sm:pb-5">Search for preferred type of campaign</li>
                        </ul>
                    ...
                    <div className="max-w-[550px]">
                        ...
                        <ul className="list-disc text-[20px] sm:text-[30px] text-[#CCCCCC] font-normal pl-10 md:pl-20">
                            ...
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Send proposal to join a campaign</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">If proposal is accepted, proceed to create and submit content.</li>
                            <li className="leading-10 md:leading-[50px] pb-2 sm:pb-5">Share approved content to connected social media channel(s) and earn!</li>
                        </ul>
                    </div>
        ...
        <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
            <p className="text-[50px] sm:text-[60px] md:text-[80px] font-bold pb-6 sm:pb-10">Issue With <br /> Existing Lo-Fi</p>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center pb-20">
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <p className="text-[25px] sm:text-3xl text-[#1692F4] leading-10 font-bold pb-5 tracking-wider">Absence Of Content Category</p>
            ...
            <div className="flex flex-col md:flex-row items-center">
                <div className="w-full md:w-1/2">
                    <p className="text-[25px] sm:text-3xl text-[#1692F4] leading-10 font-bold pb-5 tracking-wider">Not Enough Campaign Specific Metrics</p>
                    <p className="leading-10 text-[20px] sm:text-[22px] text-[#cccccc] font-normal pb-10 sm:pb-20">
        ...
        <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
            <p className="text-[50px] sm:text-[60px] md:text-[80px] font-bold pb-6 sm:pb-10">Proposed Solutions To Issues Highlighted Above</p>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center pb-20 pt-10">
                ...
                <div className="w-full md:w-1/2">
                    <p className="text-[25px] sm:text-3xl text-[#1692F4] leading-10 font-bold pb-5 tracking-wider">Added Content Category To Sign Up Form.</p>
                    <p className="leading-10 text-[20px] sm:text-[22px] text-[#cccccc] font-normal pb-10 sm:pb-20">
            ...
            <div className="flex flex-col md:flex-row items-center">
                <div className="w-full md:w-1/2">
                    <p className="text-[25px] sm:text-3xl text-[#1692F4] leading-10 font-bold pb-5 tracking-wider">Comprehensive Charts</p>
                    <p className="leading-10 text-[20px] sm:text-[22px] text-[#cccccc] font-normal pb-10 sm:pb-20">
        ...
        <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans pb-20">
            <p className="text-[50px] sm:text-[60px] md:text-[80px] font-bold pb-6 sm:pb-10">Other Features I worked On</p>
        ...
        <section className="max-w-[1300px] mx-auto pb-20">
            <div className="bg-[#1A1A1A] p-10 rounded flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="">
                    ...
                    <a href="https://www.plugtent.com/" className="text-3xl md:text-6xl text-[#1692F4] font-semibold tracking-wide border-b-4 border-[#1692f4]" target="_blank">Plugtent Web App</a>
                </div>
                ...
                <div>
                    <img className="w-20 sm:w-full" src={plugtentlogo} alt="plugtent-logo" />
                </div>
