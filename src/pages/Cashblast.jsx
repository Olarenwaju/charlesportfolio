...
const Cashblast = () => {
  return (
    ...
    <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
      ...
      <div className=" pt-28">
        <p className="text-[80px] font-bold pb-10">Overview</p>
      ...
      <div className=" pt-28">
        <p className="text-[80px] font-bold pb-10">Key Requirements</p>
        <p className="text-[32px] leading-[60px] text-[#CCCCCC] font-normal">
      ...
      <div className="flex md:flex-row flex-col gap-x-10 gap-y-8 pb-14 pt-20">
        <div className="max-w-[550px] mr-20">
          <p className=" text-white text-[40px] font-bold leading-[26px] pb-10">Big Screen:</p>
          <ul className="list-disc text-[30px] text-[#CCCCCC] font-normal leading-9 pl-20">
            <li className="leading-[50px] pb-5">Should show a unique event code / QR code for people to join, along with information they need to get in the “dance floor</li>
            <li className="leading-[50px] pb-5">When people go to the link and enter the event code on their phone, they should appear on the screen with the name they have chosen to use to join the dance floor. </li>
        ...
        <div className="max-w-[550px]">
          ...
          <ul className="list-disc text-[30px] text-[#CCCCCC] font-normal leading-9 pl-5">
            <li className="leading-[50px] pb-5">Should show an event name / hashtag. </li>
            <li className="leading-[50px] pb-5">As people are “spraying money” from their phones, the big screen should show the amounts being sprayed by each person. </li> 
            <li className="leading-[50px] pb-5">The currency is naira</li> 
          </ul>
        </div>
      ...
      <div className="flex md:flex-row flex-col gap-x-10 gap-y-8 pb-14 pt-20">
        <div className="max-w-[550px] mr-20">
          <p className=" text-white text-[40px] font-bold leading-[26px] pb-10">Mobile Web App:</p>
          <ul className="list-disc text-[30px] text-[#CCCCCC] font-normal leading-9 pl-20">
            <li className="leading-[50px] pb-5">Users should be able to create an account on the web app with their full name, email and phone number. </li>
            <li className="leading-[50px] pb-5">Users should have a wallet that they can easily fund through bank accounts or cards. </li>
            <li className="leading-[50px] pb-5">They should be able to join a party by entering the party code and a nickname to use. </li>
            <li className="leading-[50px] pb-5">When they join a party, they should be able to pick the denomination they want to use in “spraying” money (N100. N200, N500, N1,000). </li>
            <li className="leading-[50px] pb-5">If a non-user (someone without an account) joins a party using the party code, they should be prompted to create their account and load their wallet to start spraying. </li>
          </ul>
        ...
        <div className="max-w-[550px]">
          <p className=" text-white text-[40px] font-bold leading-[26px] pb-10">&nbsp;</p>
          <ul className="list-disc text-[30px] text-[#CCCCCC] font-normal leading-9 pl-5">
            <li className="leading-[50px] pb-5">Users should be able to load more money into their wallet when needed.  </li>
            <li className="leading-[50px] pb-5">When the wallet is empty, they should not be able to spray until they reload the wallet.</li> 
            <li className="leading-[50px] pb-5">Users should also be able to create an “event” from their account. </li> 
            <li className="leading-[50px] pb-5">Each party should have a unique code that other users can use to join the party.</li> 
            <li className="leading-[50px] pb-5">If a non-user (someone without an account) joins a party using the party code, they should be prompted to create their account and load their wallet to start spraying. </li> 
          </ul>
        </div>
    ...
    <section className="max-w-[1300px] w-full mx-auto pt-[150px] px-5 font-dmsans">
      ...
      <div className="flex flex-col md:flex-row items-center pb-28 max-w-[1200px] mx-auto">
          <div className="w-full md:w-1/2 max-w-[700px] pr-10">
              <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">Seamless Onboarding Flow</p>
          ...
          <div className="w-full md:w-1/2">
            <img className="max-w-[550px]" src={cashblastsolutions1} alt="lof1" />
          </div>
      </div>

      <div className="flex flex-col md:flex-row items-center pb-20  max-w-[1200px] mx-auto">
        <div className="w-full md:w-1/2">
          <img src={cashblastsolutions2} alt="lof1" />
        </div>

        <div className="w-full md:w-2/3">
          <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">Home Screen</p>
          <p className="leading-10 text-[21px] text-[#cccccc] font-normal pb-20">
      ...
      <div className="flex flex-col md:flex-row items-center pb-28 max-w-[1200px] mx-auto">
          <div className="w-full md:w-2/3 max-w-[700px] pr-10">
              <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">Creating An Event</p>
              <p className="leading-10 text-[21px] text-[#cccccc] font-normal">
          ...
          <div className="w-full md:w-1/2">
            <img className="max-w-[550px]" src={cashblastsolutions3} alt="lof1" />
          </div>
      </div>

      <div className="flex flex-col md:flex-row items-center pb-20 max-w-[1200px] mx-auto">
        <div className="w-full md:w-1/2">
          <img src={cashblastsolutions4} alt="lof1" />
        </div>

        <div className="w-full md:w-2/3">
          <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">Joining An Event</p>
          <p className="leading-10 text-[21px] text-[#cccccc] font-normal pb-20">
    ...
    <section className="max-w-[1300px] w-full mx-auto pt-[120px] px-5 font-dmsans">
      <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">Funding A Wallet</p>
      <p className="text-[24px] leading-[48px] text-[#CCCCCC] font-normal pb-20">
      ...
      <div className="flex flex-col md:flex-row items-center pb-20 mx-auto">
        <div className="w-full md:w-2/3">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between pb-28 max-w-[1200px] mx-auto">
          <div className="w-full md:w-2/3 max-w-[700px] pr-10">
              <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">The Actual Spraying Procees</p>
              <p className="leading-10 text-[24px] text-[#cccccc] font-normal">
      ...
      <p className="text-3xl text-[#1D4ED8] leading-10 font-bold pb-5 tracking-wider">The Big Screen</p>
      <p className="text-[24px] leading-[48px] text-[#CCCCCC] font-normal pb-20">
    ...
    <section className="max-w-[1250px] mx-auto pb-20 pt-28">
      <div className="bg-[#1A1A1A] p-10 rounded flex flex-col md:flex-row md:justify-between justify-center items-center gap-4">
        <div className="pr-20">
          ...
          <a href="https://www.plugtent.com/" className="text-6xl text-[#1D4ED8] font-semibold tracking-wide" target="_blank">Cashblast Website</a>
        </div>
      </div>
