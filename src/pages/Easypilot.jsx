  ...
  return (
    <>
      <section className="relative max-w-[1300px] w-full mx-auto pt-20 sm:pt-24 md:pt-[150px] px-4 sm:px-5 font-dmsans">
        ...
        <div className="flex flex-col lg:flex-row justify-between pt-20 pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
          ...
          <div className="max-w-[850px] text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
            <p>
              ...
              verified, professional drivers who drive the owners&apos; personal
              vehicles. It was designed to simplify how car owners hire trusted
              drivers, whether for daily commutes, errands, or intercity travel,
          ...
          <div className="max-w-[850px] w-full">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl md:text-[28px] lg:text-[32px] xl:text-[36px] font-bold pb-3 sm:pb-4 leading-tight">
                The Challenge: Modernizing How Drivers and Car Owners Connect
              </h1>
              <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                <p className="pb-6 sm:pb-8 md:pb-10">
                  ...
                  faced structural limitations in how driving services operated.
                  Existing ride-hailing platforms like{" "}
                  <span className="font-bold">Uber, Bolt, and InDrive </span>
                  catered primarily to drivers who already owned cars, leaving a
                  gap for skilled drivers without vehicles. At the same time,
                ...
                <p className="pb-6 sm:pb-8 md:pb-10">
                  Traditional methods of hiring drivers through word-of-mouth or
                  local agents often lacked reliability, safety verification,
                  and accountability. Car owners had no structured way to
                  confirm a driver&apos;s identity or professionalism, while
                  drivers had no stable system to find verified clients or build
                  credibility.
                </p>
                <div>
                  ...
                  <ul className="list-disc pl-5 sm:pl-6 space-y-2">
                    ...
                    <li>
                      Provides a structured income system for drivers without
                      vehicles.
                    </li>
                    <li>
                      Enables car owners to maximize their vehicle usage without
            ...
            <div>
              ...
              <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                ...
                <ul className="list-disc pl-5 sm:pl-6 space-y-2">
                  <li>
                    Designed intuitive onboarding flows for both drivers and car
                    owners.
                  </li>
                  <li>
                  ...
                  <li>
                    Used progress indicators and guided microcopy to build user
                    confidence.
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 sm:pl-6 pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal space-y-2">
                <li>
                  Car owners verify the driver&apos;s identity before handing
                  over keys.
                </li>
                <li>
                  Drivers confirm trip completion via a secure code shared by
                  the owner
                </li>
                <li>
                  Added an SOS feature for emergencies — discreet yet accessible
                </li>
              </ul>
              <img
                src={skillimg3}
            ...
            <div>
              ...
              <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                <ul className="list-disc pl-5 sm:pl-6 pb-6 sm:pb-8 md:pb-10 space-y-2">
                  <li>
                    Crafted flows for situations like expired timers, delayed
                    trip endings, and cancellation penalties.
                  </li>
                  <li>
                  ...
                  <li>
                    Introduced wallet balance management and clear breakdown of
                ...
                <ul className="list-disc pl-5 sm:pl-6 pb-6 sm:pb-8 md:pb-10 space-y-2">
                  <li>
                    Wrote guided prompts and confirmations that sound human, not
                    robotic.
                  </li>
                  <li>
                    Adopted a warm yet professional tone to build reassurance
                    (&quot;Your driver is on the way&quot;, &quot;Trip ended
                    successfully&quot;, &quot;Verification pending&quot;).
                  </li>
                  <li>
                    Visual consistency: neutral backgrounds, bold accent colors,
                    and clear status indicators for trust and clarity.
                  </li>
                </ul>
                ...
                <h1 className="text-xl sm:text-2xl md:text-[28px] lg:text-[32px] xl:text-[36px] font-bold pb-3 sm:pb-4">
                ...
                <p className="pb-6 sm:pb-8 md:pb-10">
                  ...
                  preferred using their own cars for trips but didn’t want to
                  deal with the stress of driving themselves while also helping
                  skilled drivers earn without owning a car. <br />
                  Through smart verification, and a smooth digital experience,
                  the platform makes every ride secure, accountable, and
                  effortless.
                </p>
              </div>
            </div>
