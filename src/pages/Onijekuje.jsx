  ...
  return (
    ...
    <section className="max-w-[1300px] w-full mx-auto pt-20 sm:pt-24 md:pt-[150px] px-4 sm:px-5 font-dmsans">
        <div className="flex flex-col lg:flex-row justify-between pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
            <div className="text-2xl sm:text-3xl md:text-[40px] lg:text-[50px] xl:text-[70px] pb-4 sm:pb-5">
                <div>
                    <h1 className="pb-1 sm:pb-3 md:pb-5 leading-tight">Onijekuje <br className="hidden sm:block" /> Shopify</h1>
                </div>
                <div className="text-sm sm:text-base md:text-[15px] lg:text-[18px] xl:text-[20px] text-[#CCCCCC] font-normal leading-relaxed">
                    <h1>A Nigerian restaurant that blends <br className="hidden sm:block"/> local authenticity with a modern dining experience</h1>
                </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
            <div>
                ...
                <div className="text-sm sm:text-base md:text-[15px] lg:text-[17px] leading-relaxed sm:leading-[25px] md:leading-[30px] text-[#CCCCCC] font-normal">
                    ...
                    <p className="text-[#cccccc] font-normal">Landing Page . Restaurant <br />Website</p>
                </div>
            ...
            <div className="max-w-[850px] text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
                <p>
                    Onijekuje Chopify is a modern culinary restaurant redefining how Nigerians experience food. 
                    Built on the foundation of authentic local flavors and innovative dining experiences, Onijekuje combines 
                    tradition with creativity to bring premium Nigerian meals to food lovers everywhere.
                </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
            ...
            <div className="max-w-[850px] w-full">
                ...
                <p className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
                    The goal of this project was to design a clean, high-performing landing page that 
                    communicates this brand&apos;s diversity while staying visually cohesive, one that feels 
                    proudly Nigerian, yet sleek enough to compete with any modern restaurant website.
                </p>
                ...
                <div>
                    ...
                    <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                        <p className="pb-6 sm:pb-8 md:pb-10">
                            The client needed a one-page website that instantly communicates what Onijekuje Chopify represents , 
                            not just as a restaurant, but as a cultural experience. The challenge was achieving balance: 
                            reflecting the warmth and familiarity of local cuisine while maintaining a premium, 
                            clean aesthetic that appeals to modern diners.
                        </p>
                        
                        <div>
                            <p className="pb-3 sm:pb-4 md:pb-5">Key challenges included:</p>
                            <ul className="list-disc pl-5 sm:pl-6 space-y-2">
                                <li>Capture Nigerian cultural essence without overwhelming the design.</li>
                                <li>Create a smooth visual flow from brand introduction to call-to-action.</li>
                                <li>Ensure responsiveness across devices without compromising design appeal.</li>
                                <li>Designing a layout that&apos;s visually engaging without overwhelming users.</li>
                                <li>Communicating credibility and location clearly to drive offline visits.</li>
                            </ul>
                        </div>
                ...
                <div>
                    ...
                    <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                        ...
                        <p className="pb-6 sm:pb-8 md:pb-10">
                            I studied local restaurant websites and global food brands to identify design gaps. 
                            The insight: most local eateries lack a digital presence that feels both authentic and premium.
                            This became the foundation for Chopify&apos;s design direction.
                        </p>
                        ...
                        <p className="pb-6 sm:pb-8 md:pb-10">
                            I started with a simple sketch and layout structure; Hero section, Menu, Upcoming Events, 
                            Reservations, Contact Us Form. The focus was ensuring each section communicated purpose 
                            within a single scroll experience.
                        </p>
                       
                    </div>
                    
                    <img src={onijekujeimg1} className="w-full mx-auto pb-6 sm:pb-8 md:pb-10" alt="onijekujeimg1"/>
                </div>

                <div>
                    <h1 className="text-xl sm:text-2xl md:text-[24px] lg:text-[28px] font-bold pb-3 sm:pb-4 md:pb-5 text-white leading-tight">3. Final Outcome</h1>
                    <p className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
                        I focused on simplicity, warmth, and clarity. Using a minimal yet bold style guide inspired by Nigerian culinary aesthetics, 
                        I balanced traditional elements with a modern digital presentation. I prioritized:
                    </p>
                    <ul className="list-disc pl-5 sm:pl-6 pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal space-y-2">
                        <li>A clean navigation flow that lets users move effortlessly between sections</li>
                        <li>Subtle animations to make interactions feel smooth and lively.</li>
                        <li>Consistent typography and color palette that reflect the brand&apos;s personality, vibrant, inviting, and confident.</li>
                    </ul>
                    
                    <img src={onijekujeimg3} className="w-full mx-auto pb-6 sm:pb-8 md:pb-10" alt="onijekujeimg3"/>
                </div>

                <div>
                    <h1 className="text-xl sm:text-2xl md:text-[24px] lg:text-[28px] font-bold pb-3 sm:pb-4 md:pb-5 text-white leading-tight">Impact Highlights:</h1>
                    <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                        
                        <ul className="list-disc pl-5 sm:pl-6 space-y-2">
                            <li>Clear brand communication within the first scroll.</li>
                            <li>Increased engagement through high visual appeal and structured layout.</li>
                            <li>Consistent traffic redirection from social media to the landing page.</li>
                        </ul>
    ...
    <section className="max-w-[1300px] w-full mx-auto pt-12 sm:pt-16 md:pt-20 lg:pt-[100px] pb-12 sm:pb-16 md:pb-20 lg:pb-28 px-4 sm:px-5 font-dmsans">
        ...
        <div className="pb-12 sm:pb-16 md:pb-20 lg:pb-28">
            <img src={onijekujeimg4} alt="onijekujeimg4" className="w-full h-auto" />
        </div>
