        ...
        <div className="flex flex-col lg:flex-row justify-between pb-10 sm:pb-12 md:pb-16 gap-6 lg:gap-x-10">
          ...
          <div className="max-w-[850px] text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
            <p>
              ...
              combines tradition with creativity to bring premium Nigerian meals
          ...
          <div className="max-w-[850px] w-full">
            ...
            <div>
              ...
              <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                <p className="pb-6 sm:pb-8 md:pb-10">
                  ...
                  communicates what Onijekuje Chopify represents , not just as a
                  restaurant, but as a cultural experience. The challenge was
                  achieving balance: reflecting the warmth and familiarity of
                  local cuisine while maintaining a premium, clean aesthetic
                  that appeals to modern diners.
                </p>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 sm:pl-6 space-y-2">
                    <li>
                      Capture Nigerian cultural essence without overwhelming the
                      design.
                    </li>
                    <li>
                    ...
                    <li>
                      Ensure responsiveness across devices without compromising
                      design appeal.
                    </li>
                    <li>
                      Designing a layout that&apos;s visually engaging without
                      overwhelming users.
                    </li>
                    <li>
                      Communicating credibility and location clearly to drive
                      offline visits.
                    </li>
                  </ul>
                </div>
            ...
            <div>
              ...
              <div className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal">
                ...
                <p className="pb-6 sm:pb-8 md:pb-10">
                  I studied local restaurant websites and global food brands to
                  identify design gaps. The insight: most local eateries lack a
                  digital presence that feels both authentic and premium. This
                  became the foundation for Chopify&apos;s design direction.
                </p>
                ...
                <p className="pb-6 sm:pb-8 md:pb-10">
                  ...
                  section, Menu, Upcoming Events, Reservations, Contact Us Form.
                  The focus was ensuring each section communicated purpose
            ...
            <div>
              ...
              <p className="pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[30px] leading-relaxed sm:leading-[30px] md:leading-[40px] lg:leading-[45px] xl:leading-[50px] text-[#CCCCCC] font-normal">
                I focused on simplicity, warmth, and clarity. Using a minimal
                yet bold style guide inspired by Nigerian culinary aesthetics, I
                balanced traditional elements with a modern digital
                presentation. I prioritized:
              </p>
              <ul className="list-disc pl-5 sm:pl-6 pb-6 sm:pb-8 md:pb-10 text-base sm:text-lg md:text-[20px] lg:text-[24px] xl:text-[28px] leading-relaxed sm:leading-[30px] md:leading-[35px] lg:leading-[40px] text-[#CCCCCC] font-normal space-y-2">
                ...
                <li>
                  Subtle animations to make interactions feel smooth and lively.
                </li>
                <li>
                  Consistent typography and color palette that reflect the
                  brand&apos;s personality, vibrant, inviting, and confident.
                </li>
              </ul>
